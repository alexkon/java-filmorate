...
public class UserService {
    ...
    public User update(User user) {
        ...
        if (userStorage.getById(userId) == null) {
            throw new NotFoundException(String.format("Пользователь с id=%s не зарегистрирован", userId));
        }
    ...
    public List<User> getFriendsByUserId(long userId) {
        final User user = getUserNotNull(userId);
        return getFriends(user.getFriendIds());
    }
    ...
    public List<User> getCommonFriends(long userId, Long otherId) {
        ...
        return getFriends(commonFriends);
    }
    ...
    private List<User> getFriends(Set<Long> friendIds) {
